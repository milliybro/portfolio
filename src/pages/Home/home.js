...
import "./home.scss";
import gifHero from "../../assets/images/mylogo.png";

import ReactJsImg from "./../../assets/images/React-icon.svg.png";
import NodeImg from "./../../assets/images/node.png";
import { ReactComponent as MongoImg } from "./../../assets/images/mongodb-icon-1.svg";
...
import { ReactComponent as TailwindImg } from "../../assets/images/tailwind.svg";
const Data = [
  {
    id: 0,
...
function Home() {
  ...
  return (
    <div className="home">
      <div className="home-intro hidden show">
        <div className="content">
          <div className="content-tertiary">
            <p>
              <span>🖐️</span> Hi there! I'm MilliyBro
            </p>
          </div>
        ...
        <div className="hero-icon">
          <img className="gifHero" src={gifHero} alt="" />
        </div>
      </div>
      <div className="tooling hidden show">
        ...
        <div className="tooling-box">
          <div className="box-content">
            <div className="box-icon">
              <img className="icon" src={ReactJsImg} alt="" />
            </div>
          ...
          <div className="box-content">
            <div className="box-icon">
              <img className="icon" src={NodeImg} alt="" />
            </div>
            <div className="box-text">
              <p>Node</p>
            </div>
          ...
          <div className="box-content">
            <div className="box-icon">
              <img className="icon" src={SassImg} alt="" />
            </div>
            <div className="box-text">
              <p>Sass</p>
            </div>
          ...
          <div className="box-content">
            <div className="box-icon">
              <img className="icon" src={TsImg} alt="" />
            </div>
            <div className="box-text">
              <p>Typescript</p>
            </div>
      ...
      <div className="quote hidden show">
        <div className="quote-body">
          <QuoteLeft className="left" />
          <div className="quote-body-content">
            <p>
              The dark night discovers the bright stars<span>!</span>
            </p>
          </div>
